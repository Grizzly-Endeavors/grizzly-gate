...
- **`/grizzly-gate:check`** — a user-invoked skill that runs the gate against the current repo and summarizes the verdict, reading `grizzly-gate-report/report.json` on failure. Won't auto-fire; you run it on demand.
